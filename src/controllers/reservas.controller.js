...
export const getReservacion = async (req, res) =>{
    ...
    .query('Select * from Reservaciones where ReservacionID = @ReservacionID')
...
export const createReservacion = async (req, res) =>{
    ...
    .query('Insert into Reservaciones (MesaID, FechaReservacion, ClienteID, Observaciones) values (@MesaID, @FechaReservacion, @ClienteID, @Observaciones); Select SCOPE_IDENTITY() as ReservacionID')
    
    console.log(result)

    res.json({
        id: result.recordset[0].ReservacionID,
...
export const putReservacion = async (req, res) =>{
    ...
    .input('ClienteID', sql.Int, req.body.ClienteID)
    .input('Observaciones', sql.VarChar, req.body.Observaciones)
    .query('Update Reservaciones set MesaID= @MesaID, FechaReservacion = @FechaReservacion, ClienteID= @ClienteID, Observaciones= @Observaciones where ReservacionID = @ReservacionID')
